...
```toml
[dependencies]
declafka_lib = { git = "https://github.com/jamesforward999/declafka", tag = "v0.0.4-alpha" }
declafka_macro = { git = "https://github.com/jamesforward999/declafka", tag = "v0.0.4-alpha" }
